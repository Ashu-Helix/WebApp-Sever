...
$jscomp.generator.Engine_.prototype.yieldAllStep_ = function (a, b, c) {
    try {
        ...
        var e = d.value
    } catch (f) { return this.context_.yieldAllIterator_ = null, this.context_.throw_(f), this.nextStep_() }
...
var player_visit_history = [],
    signal_status = [!1, !1, !1],
    traffic_signal = { x: 300, y: 0, width: 1500, height: 2250 },
    red_light = { x: 830, y: 200, width: 400, height: 400 },
    amber_light = { x: 830, y: 680, width: 400, height: 400 },
    green_light = { x: 830, y: 1150, width: 400, height: 400 },
    bg = new Image;
bg.src = "/img/Background1.png";
var traffic_signal_image = new Image;
traffic_signal_image.src = "/img/traffic_signal.png";
var red_light_image = new Image;
red_light_image.src = "/img/Red_Light.png";
var amber_light_image = new Image;
amber_light_image.src = "/img/Amber_Light.png";
var green_light_image = new Image;
green_light_image.src = "/img/Green_Light.png";
bg.onload = function () {
    ctx.drawImage(bg, 0, 0, canvas.width, canvas.height);
    ctx.drawImage(traffic_signal_image, traffic_signal.x, traffic_signal.y, traffic_signal.width, traffic_signal.height)
};
...
function red(a) {
    return $jscomp.asyncExecutePromiseGeneratorProgram(function (b) {
        return b["return"](new Promise(function (c, d) {
            return $jscomp.asyncExecutePromiseGeneratorProgram(function (e) {
                if (1 == e.nextAddress) return signal_status[0] = a, e.yield(render_output(), 2);
                c();
                e.jumpToEnd()
            })
        }))
...
function amber(a) {
    return $jscomp.asyncExecutePromiseGeneratorProgram(function (b) {
        return b["return"](new Promise(function (c, d) {
            return $jscomp.asyncExecutePromiseGeneratorProgram(function (e) {
                if (1 == e.nextAddress) return signal_status[1] = a, e.yield(render_output(), 2);
                c();
                e.jumpToEnd()
            })
        }))
...
function green(a) {
    return $jscomp.asyncExecutePromiseGeneratorProgram(function (b) {
        return b["return"](new Promise(function (c, d) {
            return $jscomp.asyncExecutePromiseGeneratorProgram(function (e) {
                if (1 == e.nextAddress) return signal_status[2] = a, e.yield(render_output(), 2);
                c();
                e.jumpToEnd()
            })
        }))
...
function startAnimating() {
    return $jscomp.asyncExecutePromiseGeneratorProgram(function (a) {
        return a["return"](new Promise(function (b, c) {
...
function render_output() {
    return $jscomp.asyncExecutePromiseGeneratorProgram(function (a) {
        return a["return"](new Promise(function (b, c) {
            ...
            ctx.drawImage(bg, 0, 0, canvas.width, canvas.height);
            ctx.drawImage(traffic_signal_image, traffic_signal.x, traffic_signal.y, traffic_signal.width, traffic_signal.height);
            signal_status[0] && ctx.drawImage(red_light_image, red_light.x, red_light.y, red_light.width, red_light.height);
            signal_status[1] && ctx.drawImage(amber_light_image, amber_light.x,
                amber_light.y, amber_light.width, amber_light.height);
            signal_status[2] && ctx.drawImage(green_light_image, green_light.x, green_light.y, green_light.width, green_light.height);
            b()
        }))
    })
}
...
export { green, amber, red, wait, reset_output, startAnimating } 
